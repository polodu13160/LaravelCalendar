    ...
    <head>
        ...
        <style>
            ...
            *,
            ...
            .focus-visible\:ring-\[\#475b10\]:focus-visible {
                --tw-ring-opacity: 1;
            ...
            @media (prefers-color-scheme: dark) {
                ...
                .dark\:focus-visible\:ring-\[\#475b10\]:focus-visible {
                    --tw-ring-opacity: 1;
                    --tw-ring-color: rgb(255 45 32 / var(--tw-ring-opacity));
                }
                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    ...
                    >
                        ...
                        <nav class="-mx-3 flex flex-1 justify-end">
                            ...
                            <a
                                href="{{ url('dashboard') }}"
                                class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#475b10]"
                            >
                                Dashboard
                            </a>
                            @else
                        ...
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            ...
                            >
                                ...
                                >
                                    <img
                                        src="{{
                                            asset('img/fullcalendar-1.png')
                                        }}"
                                        alt="B2P Calendar screenshot"
                                ...
                                >
                                    ...
                                    <svg
                                        class="size-6 shrink-0 stroke-[#475b10]"
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="none"
                                        viewBox="0 0 24 24"
                                        stroke-width="1.5"
                            ...
                            >
                                ...
                                <svg
                                    class="size-6 shrink-0 self-center stroke-[#475b10]"
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    stroke-width="1.5"
