                            ...
                            <x-slot name="trigger">
                                <span class="inline-flex rounded-md">
                                    <button type="button"
                                        ...
                                        {{ $teamUser ? Auth::user()->currentTeam->name : 'No team' }}
                                ...
                                <div class="w-60">
                                    ...
                                    @isAdmin
                                        @can('create', Laravel\Jetstream\Jetstream::newTeamModel())
                                            <x-dropdown-link href="{{ route('teams_create') }}">
                                                {{ __('Create New Team') }}
                                            </x-dropdown-link>
                                        @endcan
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                @if (Laravel\Jetstream\Jetstream::hasTeamFeatures())
                    ...
                    @can('create', Laravel\Jetstream\Jetstream::newTeamModel())
                        <x-responsive-nav-link href="{{ route('teams_create') }}" :active="request()->routeIs('teams_create')">
                            {{ __('Create New Team') }}
                        </x-responsive-nav-link>
                    @endcan
